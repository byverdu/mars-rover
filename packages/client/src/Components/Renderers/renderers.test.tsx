...
describe('Renderers', () => {
  describe('renderPlateauInfo', () => {
    ...
    it('should return the width and height as text', () => {
      const wrapper = shallow(<div>{renderPlateauInfo(3, 3)}</div>);
  ...
  describe('renderRoverPosition', () => {
    ...
    it('should return the width and height as text', () => {
      const wrapper = shallow(<div>{renderRoverPosition('3 3 N')}</div>);

      expect(wrapper.find('h3').text()).toEqual(
        'Initial Rover Position: 3 3 N'
      );
    });
  });
  ...
  describe('renderRoverNextSteps', () => {
    ...
    it('should return the width and height as text', () => {
      const wrapper = shallow(<div>{renderRoverNextSteps('LLMMRR')}</div>);
